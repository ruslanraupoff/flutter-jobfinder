...
class JobFinderTwo extends StatefulWidget {
  const JobFinderTwo({Key? key}) : super(key: key);

  @override
  State<JobFinderTwo> createState() => _JobFinderTwoState();
}

class _JobFinderTwoState extends State<JobFinderTwo>
