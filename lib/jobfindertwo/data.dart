...
List<Application> getApplications(){
  return <Application>[
    ...
    Application("Flutter UI Designer", "Amazon Inc.", "Not selected", "60", "assets/images/amazon.jpeg"),
  ];
}
...
List<Job> getJobs(){
  return <Job>[
    ...
    Job("Flutter Developer", "Amazon Inc.", "60", "Full-Time", "assets/images/amazon.jpeg", "San Francisco, California"),
  ];
}
