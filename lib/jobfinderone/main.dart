...
class JobFinderOne extends StatefulWidget {
  const JobFinderOne({Key? key}) : super(key: key);

  @override
  State<JobFinderOne> createState() => _JobFinderOneState();
}

class _JobFinderOneState extends State<JobFinderOne>
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    _jobCategory(
                        "Design\nJob", Colors.blue.shade50, Colors.blue),
                    SizedBox(
                      width: 3 * SizeConfig.widthMultiplier,
                    ),
                    _jobCategory("Development", Colors.red.shade50, Colors.red),
                    SizedBox(
                      width: 3 * SizeConfig.widthMultiplier,
                    ),
                    _jobCategory("Sales", Colors.orange.shade50, Colors.orange),
                    SizedBox(
                      width: 3 * SizeConfig.widthMultiplier,
                    ),
                    _jobCategory(
                        "Marketing", Colors.purple.shade50, Colors.purple),
                    SizedBox(
                      width: 3 * SizeConfig.widthMultiplier,
                    ),
                    _jobCategory("Engineer", Colors.teal.shade50, Colors.teal),
                    SizedBox(
                      width: 5 * SizeConfig.widthMultiplier,
                    ),
                  ],
